...
def populate_initial_data():
    with app.app_context():
        # Remove verificações condicionais, já que create_app() limpa o banco
        institutions = [
        ...
        try:
            gestores = [
                # Gestores de Saúde
                {'id': str(uuid.uuid4()), 'email': 'gestor.camama@saude.com', 'password': 'admin123', 'user_tipo': 'gestor', 'institution_id': institutions[0]['id'], 'department': 'Consulta Médica'},
                ...
                {'id': str(uuid.uuid4()), 'email': 'gestor.identificacao@luanda.com', 'password': 'admin123', 'user_tipo': 'gestor', 'institution_id': institutions[2]['id'], 'department': 'Identificação'},
                {'id': str(uuid.uuid4()), 'email': 'gestor.registo@luanda.com', 'password': 'admin123', 'user_tipo': 'gestor', 'institution_id': institutions[2]['id'], 'department': 'Registo Civil'},
                # Gestores Bancários
                {'id': str(uuid.uuid4()), 'email': 'gestor.bfa@kilamba.com', 'password': 'admin123', 'user_tipo': 'gestor', 'institution_id': institutions[3]['id'], 'department': 'Contas'},
                # Gestores de Educação
                {'id': str(uuid.uuid4()), 'email': 'gestor.escola@cazenga.com', 'password': 'admin123', 'user_tipo': 'gestor', 'institution_id': institutions[4]['id'], 'department': 'Matrículas'},
                # Gestores de Transportes
                {'id': str(uuid.uuid4()), 'email': 'gestor.transito@talatona.com', 'password': 'admin123', 'user_tipo': 'gestor', 'institution_id': institutions[5]['id'], 'department': 'Licenciamento'},
                # Gestores de Correios
                {'id': str(uuid.uuid4()), 'email': 'gestor.correios@maianga.com', 'password': 'admin123', 'user_tipo': 'gestor', 'institution_id': institutions[6]['id'], 'department': 'Encomendas'},
                {'id': str(uuid.uuid4()), 'email': 'gestor.correspondencia@maianga.com', 'password': 'admin123', 'user_tipo': 'gestor', 'institution_id': institutions[6]['id'], 'department': 'Correspondência'},
                # Gestores de Energia e Águas
                {'id': str(uuid.uuid4()), 'email': 'gestor.ende@rangel.com', 'password': 'admin123', 'user_tipo': 'gestor', 'institution_id': institutions[7]['id'], 'department': 'Faturação'},
                {'id': str(uuid.uuid4()), 'email': 'gestor.atendimento@rangel.com', 'password': 'admin123', 'user_tipo': 'gestor', 'institution_id': institutions[7]['id'], 'department': 'Atendimento ao Cliente'},
                {'id': str(uuid.uuid4()), 'email': 'gestor.epal@samba.com', 'password': 'admin123', 'user_tipo': 'gestor', 'institution_id': institutions[8]['id'], 'department': 'Faturação'},
                {'id': str(uuid.uuid4()), 'email': 'gestor.atendimento@samba.com', 'password': 'admin123', 'user_tipo': 'gestor', 'institution_id': institutions[8]['id'], 'department': 'Atendimento ao Cliente'},
                # Gestores de Telecomunicações
                {'id': str(uuid.uuid4()), 'email': 'gestor.unitel@cazenga.com', 'password': 'admin123', 'user_tipo': 'gestor', 'institution_id': institutions[9]['id'], 'department': 'Atendimento ao Cliente'},
                {'id': str(uuid.uuid4()), 'email': 'gestor.suporte@cazenga.com', 'password': 'admin123', 'user_tipo': 'gestor', 'institution_id': institutions[9]['id'], 'department': 'Suporte'},
            ]
