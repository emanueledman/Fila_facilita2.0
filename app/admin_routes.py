...
def init_admin_routes(app):
    ...
    def list_admin_queues():
        ...
        # MODIFICAÇÃO: Filtrar apenas pelo departamento do gestor, não por toda a instituição
        queues = Queue.query.filter_by(
            institution_id=user.institution_id,
            department=user.department  # Filtra apenas pelo departamento específico do gestor
        ).all()
    ...
    def admin_call_next(queue_id):
        ...
        # MODIFICAÇÃO: Verificar se a fila pertence ao departamento do gestor
